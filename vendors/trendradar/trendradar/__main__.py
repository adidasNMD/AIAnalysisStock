...
class NewsAnalyzer:
    ...
    def _crawl_data(self) -> Tuple[Dict, Dict, List]:
        ...
        rss_names = [r.get('name', r.get('id', '')) for r in self.ctx.rss_feeds] if hasattr(self.ctx, 'rss_feeds') else []
        all_monitored = platform_names + rss_names
        print(f"配置的监控节点: {all_monitored}")
